...
using Coplt.Miscellaneous.Analyzers.Utilities;
...
internal static class Utils
{
    ...
    public static DiagnosticDescriptor MakeError(int id, LocalizableString msg)
        => new($"COMIC_E{id:0000}", msg, msg, "", DiagnosticSeverity.Error, true, description: msg);

    public static DiagnosticDescriptor MakeWarning(int id, LocalizableString msg)
        => new($"COMIC_W{id:0000}", msg, msg, "", DiagnosticSeverity.Warning, true, description: msg);

    public static DiagnosticDescriptor MakeInfo(int id, LocalizableString msg)
        => new($"COMIC_I{id:0000}", msg, msg, "", DiagnosticSeverity.Info, true, description: msg);
